...
# CHANGE THESE
TOEMAIL="tomasz.jekiel@hycom.pl";
FREMAIL="test@hycom.pl";
SUBJECT="Daily Backup - $YYYYMMDD";
MSGBODY="Hello this is the message body";
ATTACHMENT="/home/tjekiel/tmp/holidays/logos/PL-Xmas-logos-gift-DECATHLON.png"
